  ...
  return (
    <main className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Build ATS-friendly resumes, automate job alerts, and find curated courses." />
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild variant="hero" size="lg">
              <Link to="/resume" aria-label="Start Resume Builder">
                <FileText className="mr-2" /> Build Resume <ArrowRight className="ml-2" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg">
              <Link to="/jobs" aria-label="Find Jobs">
